...
export default function AdminDashboard() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'in-progress': return 'bg-blue-900/20 text-blue-300 border-blue-500/30';
      case 'resolved': return 'bg-green-900/20 text-green-300 border-green-500/30';
      case 'rejected': return 'bg-red-900/20 text-red-300 border-red-500/30';
      default: return 'bg-gray-800/20 text-gray-300 border-gray-500/30';
    }
  };

  const getPriorityColor = (priority: string) => {
    switch (priority) {
      case 'urgent': return 'bg-red-900/20 text-red-300 border-red-500/30';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8 animate-fade-in">
            <div className="flex items-center mb-6">
              ...
              <div>
                ...
                <p className="text-gray-400">Welcome back, {user.name}! Manage your community with precision.</p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-6 hover:bg-gray-800/70 transition-all duration-300 hover:scale-105">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-white">{stats.pendingIssues}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-6 hover:bg-gray-800/70 transition-all duration-300 hover:scale-105">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-white">{stats.inProgressIssues}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-6 hover:bg-gray-800/70 transition-all duration-300 hover:scale-105">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-white">{stats.resolvedIssues}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-6 mb-8 hover:bg-gray-800/70 transition-all duration-300">
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-xl font-bold text-white">Voice Support</h3>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <button
                onClick={() => setShowInitiateCallModal(true)}
                className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-medium transition-all duration-300 hover:scale-105 flex items-center justify-center gap-2"
              >
              ...
              <button
                ...
                className="bg-gray-700 hover:bg-gray-600 text-white px-6 py-3 rounded-lg font-medium transition-all duration-300 hover:scale-105 flex items-center justify-center gap-2 border border-gray-600 hover:border-gray-500"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* Payment Gateway */}
          <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-lg p-4 mb-6 hover:bg-gray-800/60 transition-all duration-300">
  <div className="flex items-center justify-between">
    <div className="flex items-center">
      <div className="w-8 h-8 bg-gradient-to-br from-green-500 to-green-600 rounded-md flex items-center justify-center mr-2">
        <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" />
        </svg>
      </div>
      <h3 className="text-sm font-medium text-white">Payment Gateway</h3>
    </div>
    
    <button
      onClick={handlePayment}
      className="bg-green-600 hover:bg-green-500 text-white text-sm px-3 py-1.5 rounded-md font-medium transition-all duration-200 flex items-center gap-1.5"
    >
      ...
      Pay Now
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-6 mb-8 hover:bg-gray-800/70 transition-all duration-300">
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-xl font-bold text-white">Filter Issues</h3>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200"
            ...
            <div className="divide-y divide-gray-700">
              {fetching ? (
                ...
                <div className="px-6 py-12 text-center">
                  ...
                  <h3 className="mt-2 text-sm font-medium text-gray-300">No issues found</h3>
                  <p className="mt-1 text-sm text-gray-500">No issues match your current filters.</p>
                </div>
              ) : (
                issues.map((issue) => (
                  <div key={issue._id} className="px-6 py-4 hover:bg-gray-800/30 transition-colors duration-200">
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        {issue.source === 'voice_call' && issue.voiceCallData && (
                          <div className="mt-3 p-3 bg-green-900/20 border border-green-500/30 rounded-lg">
                            <p className="text-sm text-green-300 font-medium mb-2">Voice Call Details:</p>
                            ...
                            {issue.voiceCallData.conversationSummary && (
                              <div className="mt-2">
                                <strong className="text-xs text-green-300">Summary:</strong>
                                <p className="text-xs text-green-300 mt-1">{issue.voiceCallData.conversationSummary}</p>
                              </div>
                            )}
                          </div>
                        )}
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <select
                          ...
                          disabled={loading}
                          className="px-3 py-1 bg-gray-700 border border-gray-600 rounded-md text-sm text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
        ...
        {showInitiateCallModal && (
          <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50">
            <div className="bg-gray-800 border border-gray-700 rounded-2xl shadow-2xl p-8 max-w-md w-full mx-4">
              <h2 className="text-2xl font-bold text-white mb-6">Initiate Voice Call</h2>
              <form onSubmit={handleInitiateCall} className="space-y-6">
                ...
                <div className="flex space-x-4">
                  <button
                    ...
                    className="flex-1 bg-blue-600 hover:bg-blue-700 text-white py-3 px-4 rounded-lg font-semibold transition-colors duration-200 disabled:opacity-50"
                  >
                  ...
                  <button
                    ...
                    className="flex-1 bg-gray-700 hover:bg-gray-600 text-white py-3 px-4 rounded-lg font-semibold transition-colors duration-200 border border-gray-600 hover:border-gray-500"
                  >
                    Cancel
                  </button>
                </div>
